...
def write_to_csv(games, game_header):
    ...
    with open('C:\\Users\\amugalde\\OneDrive - ASECCSS\\Personal\\Python\\Lyfter\\week 8\\CSV\\CSV_FILE\\games.txt', mode='w', newline = '', encoding='utf-8') as file: 
        escritor = csv.DictWriter(file, game_header) #file = archivo que se trabajara / #game_header es la tupla que son las columnas
